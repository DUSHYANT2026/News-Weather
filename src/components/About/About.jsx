...
export default function About() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Customize topics and locations",
      icon: "📍",
    },
    {
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          ...
          <div className="text-center mb-10">
            ...
            >
              Stay informed with real-time news and weather updates delivered
              instantly to your fingertips.
            </p>
          </div>
          ...
          <div className="md:flex md:gap-8 lg:items-center">
            ...
            <div className="md:w-3/5">
              ...
              >
                ...
                >
                  To deliver real-time, accurate news and weather information
                  with a seamless user experience. Stay connected with the world
                  through curated content and live updates tailored to your
                  interests.
                </p>
              </div>
